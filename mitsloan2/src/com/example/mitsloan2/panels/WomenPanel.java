...
import com.example.mitsloan2.adapters.WomenPanelImageAdapter;
...
public class WomenPanel extends Activity{
	@Override
	protected void onCreate(Bundle savedInstanceState) {
        ...
        gridView.setAdapter(new WomenPanelImageAdapter(this));
	}
