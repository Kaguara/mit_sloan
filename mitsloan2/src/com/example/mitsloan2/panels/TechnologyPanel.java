...
import com.example.mitsloan2.adapters.TechnologyPanelImageAdapter;
...
public class TechnologyPanel extends Activity{
	@Override
	protected void onCreate(Bundle savedInstanceState) {
        ...
        gridView.setAdapter(new TechnologyPanelImageAdapter(this));
	}
