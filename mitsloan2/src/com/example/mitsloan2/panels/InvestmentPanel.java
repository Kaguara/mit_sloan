...
import com.example.mitsloan2.adapters.InvestmentPanelImageAdapter;
...
public class InvestmentPanel extends Activity{
	@Override
	protected void onCreate(Bundle savedInstanceState) {
        ...
        gridView.setAdapter(new InvestmentPanelImageAdapter(this));
	}
