...
import com.example.mitsloan2.backend.GCMIntentService;
import com.example.mitsloan2.backend.core.CloudEndpointUtils;
import com.example.mitsloan2.backend.core.Consts;
import com.example.mitsloan2.messageEndpoint.MessageEndpoint;
import com.example.mitsloan2.messageEndpoint.model.CollectionResponseMessageData;
import com.example.mitsloan2.messageEndpoint.model.MessageData;
    ...
    registerListener = new OnTouchListener() {
      ...
      public boolean onTouch(View v, MotionEvent event) {
        ...
        case MotionEvent.ACTION_DOWN:
          if (Consts.PROJECT_NUMBER == null
              || Consts.PROJECT_NUMBER.length() == 0) {
            ...
            try {
              GCMIntentService.doRegister(getApplicationContext());
            } catch (Exception e) {
